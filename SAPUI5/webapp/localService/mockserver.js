...
/** Initializes the mock SErver asynchonously
 * @protected
 * @param {object} oOptionsParameter
 * @returns{promise}  a promised that is resolved when the mock server has been started
 *  
 */
   ...
   return new Promise ( function( fnResolve, fnReject) {
     var sManifestUrl = sap.ui.require.toUrl(_sAppPath + "manifest.json" ),
         ...
         oManifestModel.attachRequestCompleted( function(){
            ...
            // create a mock serverinstance or stop the existing one  to reinitialize
            ...
            // configure mock server with the given options or a default  delay
