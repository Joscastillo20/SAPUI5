            ...
            onInit: function () {
                ...
                this._bus.subscribe("incidence", "onDeleteIncidence", function (channelId, eventId, data) {
                    ...
                    this.getView().getModel("incidenceModel").remove("/IncidentsSet(IncidenceId='"
                        + data.IncidenceId + "',SapId='"
                        + data.SapId + "',EmployeeId='"
                        + data.EmployeeId + "')", {
                        success: function () {
            ...
            onSaveODataIncidence: function (channelId, eventId, data) {
                ...
                if (typeof incidenceModel[data.incidenceRow].IncidenceId == 'undefined') {
                    ...
                    this.getView().getModel("incidenceModel").update("/IncidentsSet(IncidenceId='"
                        + incidenceModel[data.incidenceRow].IncidenceId + "',SapId='"
                        + incidenceModel[data.incidenceRow].SapId + "',EmployeeId='"
                        + incidenceModel[data.incidenceRow].EmployeeId + "')", body, {
                        success: function () {
                            this.onReadODataIncidence.bind(this)(employeeId);
                ...
                this.getView().getModel("incidenceModel").read("/IncidentsSet", {
                    ...
                    success: function (data) {
                        ...
                        for (var incidence in data.results) {
                            ...
                            var newIncidence = new sap.ui.xmlfragment("logaligroup.Employees.fragment.NewIncidence", this._detailEmployeeView.getController());
